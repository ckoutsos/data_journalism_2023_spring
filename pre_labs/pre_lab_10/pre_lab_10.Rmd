...
**Answer** object id, zipcode2, zip name, existing??, zip code 1, shape length, shape area, geometry
...
**Answer** the length of the shape and the area of the shape of the map of different zip codes and the shapr they take "multipolygon" of different spots in Maryland
...
**Answer** a map of maryland is shown with a boundary for every zip code. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** gets us a dataframe of every county in the U.S. with a geometry column
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**  just shows the maryland counties in a dataframe instead of all the counties in the US w/ geometry
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** plotted the MD counties on the map but left out the chesapeake bay 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** layered data: first one is counties and second ones is zips 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** a dataframe with totals for the number of notices sent in a zip code in march 2023
...
**Task** Run the following code. Describe the output in the space below.
**Answer** joined the maryland zip codes with geometry and the zip code foreclosure data
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** mapped the zip code foreclosure data: added an aesthetic (color the shape based on number of notices: fill)
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Using slice 1 to give first row of data and leave everythign else behind/ data is wide and makes wide data into long data (reshape data)
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Gives a geometry column to the md county population dataset
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** we have the county population and notice dataframes
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** changed the name to "county", got rid of ",Marland" portion, and then got rid of white space on each side renamed estimate column to population, and only showed county, pop, and geometry fields.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** joined the two dataframes into the md population and foreclosure and geometry column
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** added rate column per every 1000 people
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** made a map of the foreclosure data with zip codes w/ rate as the fill 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** shows the counties with more variety to distinguish between
...
**Answer** changes the rate calculations slightly and tries to point out whats alike and what's not. frederick county changes color. charles county is still the highest and is an outlier compared to other counties

...
**Answer** creating an aggregate column and calling it count_classes
...
**Answer** sorting the data to arrange it by descending order, 2022 first in term 
...
**Answer** two things grouped, for each unique combination of term and department, A-Z 2017-2022
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer** added a column for total seats in descending order in each term that are available in addition to counting classes
...
**Answer** The top terms are in the beginning of fall semester. This added the mean, median, and total seats for the classes.
...
**Answer** It added more data with the minimum and maximum amount of seats 
...
1.  How does sorting create new trends in the data?

2.  How would it help to know the maximum and minimum number of seats as opposed to the total seats?

3.  What are the differences between different semesters, fall vs spring and different years?

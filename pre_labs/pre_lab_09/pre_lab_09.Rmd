...
https://www.datawrapper.de/_/hQtLg/
...
**Answer** Describe the changes from the previous map: It shows only Maryland, not the other parts of the US not included
...
**Answer** Describe the changes from the previous map: It makes the County name show up when you hover over the county and the percentage to the tenths place underneath.

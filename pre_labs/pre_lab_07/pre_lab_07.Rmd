...
```{r echo=FALSE}
census_api_key("8b0dedffff85f468f0f2ffe38e8703883da019db", install=TRUE)
```
...
**Task** Run the following codeblock to rename the population total columns in each dataframe: Rename value columns to rename for value of year they were for
...
What is Maryland's richest county? Montgomery? That's my guess
...
**Answer** Howard county wealthiest county, with Calvert and Montgomery at its heels (or are they really?)
...
**Answer** Baltimore City, MD had the largest percentage growth in median income, no the median income didn't decrease in any counties 
...
**Answer** Does wealth play a role in high school graduates going on to college? People with a COSA/don't go to school in the zip codes that they live in.
...
**Answer** So people with more money send their kids to college (better chance, expectation, ability), whereas less wealthy people don't have as many kids going to college 
...
**Answer** Well, I'd need more information. But I'd want to ask whether we have a certain amount of kids who transfer to other schools not in the zip code they live in (aka get a COSA) and what the income of their parents is.
